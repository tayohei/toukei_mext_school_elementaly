...
output_filename = str_c("学校基本調査_市町村別集計_小学校_学校数_",f_year,".csv")
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_編制方式別学級数_",f_year,".csv")
col_label <- c(
	"市町村名",NA,
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_編制方式別児童数_",f_year,".csv")
col_label <- c(
	"市町村名",NA,
	NA,"単式学級_1学年","単式学級_2学年","単式学級_3学年","単式学級_4学年","単式学級_5学年","単式学級_6学年",
	NA,"複式学級_2個年","複式学級_3個年","複式学級_4個年","複式学級_5個年","複式学級_6個年",
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_学年別児童数_",f_year,".csv")
col_label <- c(
	"市町村名",NA,NA,NA,
	NA,"1学年_男","1学年_女",
	NA,"2学年_男","2学年_女",
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_職名別教員数（本務者）_",f_year,".csv")
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_職名別教員数（兼務者）_",f_year,".csv")
...
output_filename = str_c("学校基本調査_市町村別集計_小学校_公立_本務教員のうち教務主任等の数_",f_year,".csv")
col_label <- c(
	"市町村名",
...
for(f_year in 2015:2018){
	...
	if(f_year<=2015){ # 2015以前はファイル形式がxls形式
		filename = str_c("ey0318_",f_year,".xls")
	}else{
		filename = str_c("ey0318_",f_year,".xlsx")
	}
	print(f_year)
	# 学校数
